...
public enum ForcedFetishTendency {
	...
	BOTTOM_ONLY("Bottoming Only", "Similar to Bottoming, but no activities and behaviors will be removed.", PresetColour.BASE_PINK),
	...
	TOP_ONLY("Topping Only", "Similar to Topping, but no activities and behaviors will be removed.", PresetColour.BASE_PURPLE_LIGHT),
